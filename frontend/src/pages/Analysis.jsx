...
function Analysis() {
  ...
  const [scanType, setScanType] = useState("OCT - Macula");
                ...
                <div className="analysis-ai-card">
                  ...
                  <div className="analysis-progress-bar">
                    <div
                      ...
                      style={{
                        width: loading ? "100%" : result ? "100%" : "0%",
                      }}
                    ></div>
                  </div>
                ...
                <div className="analysis-patient-card">
                  ...
                  <div className="analysis-row">
                    ...
                    <div className="analysis-input-group">
                      ...
                      >
                        <option value="OCT - Macula">OCT - Macula</option>
                        <option value="OCT - Optic Disc">
                          OCT - Optic Disc
                        </option>
                      </select>
                    </div>
                  ...
                  <div className="analysis-input-group">
                    ...
                    <div className="analysis-eye-buttons">
                      <button
                        type="button"
                        className={laterality === "Left" ? "active" : ""}
                      ...
                      <button
                        type="button"
                        className={laterality === "Right" ? "active" : ""}
